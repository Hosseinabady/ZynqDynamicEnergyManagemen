...
//	int *p_x = (int *)sds_alloc(LASERRAYS*sizeof(int));
//	int *p_y = (int *)sds_alloc(LASERRAYS*sizeof(int));
#ifndef __SOFTWARE__
	int *p_x = (int *)malloc(LASERRAYS*sizeof(int));
	int *p_y = (int *)malloc(LASERRAYS*sizeof(int));
#endif
