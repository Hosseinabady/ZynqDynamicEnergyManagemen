...
void runIteration_sw(void){
	...
	for (counter = 0; counter < G; counter++) { //while (counter<19){ //19 std, 30 kalitero mallon
		bestFitness_sw = 0;
...
//		POWER_MONITORING_EPILOGUE();
		...
		printf("software execution time on GA %.6lf ms elapsed\n", software_execution_time);
...
//		software_end = getTimestamp();
//		software_execution_time = (software_end-software_start)/(1000);
//		printf("software execution time on map-update %.6lf ms elapsed\n", software_execution_time);

//		software_start = getTimestamp();
		done = fixNewScans_sw();
//		software_end = getTimestamp();
//		software_execution_time = (software_end-software_start)/(1000);
//		printf("software execution time on scan %.6lf ms elapsed\n", software_execution_time);
