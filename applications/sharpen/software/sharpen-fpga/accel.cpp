				 ...
				 )
{
	...
	rd_command->register_physical_offset_address = XSHARPEN_4DU_CONTROL_BUS_ADDR_INPUT_IMAGE_OFFSET_DATA;
	rd_command->value = (u32)input_image;

	ioctl ( file_desc, FPGACL_DEVICE_IOWRITE, rd_command);
  	//---------------------------------------
	rd_command->device_kernel_base_address = (void *)device_kernel_address;
	rd_command->register_physical_offset_address = XSHARPEN_4DU_CONTROL_BUS_ADDR_OUTPUT_IMAGE_OFFSET_DATA;
	rd_command->value = (u32)output_image;
...
//	printf("accel_write: ceck point 2\n");
	...
	rd_command->register_physical_offset_address = XSHARPEN_4DU_CONTROL_BUS_ADDR_GIE;
	rd_command->value = 0;
...
//	printf("accel_start: ceck point 1\n");
	rd_command->device_physical_base_address = device_kernel_address;
	rd_command->register_physical_offset_address = XSHARPEN_4DU_CONTROL_BUS_ADDR_AP_CTRL;
	rd_command->value = 0;
