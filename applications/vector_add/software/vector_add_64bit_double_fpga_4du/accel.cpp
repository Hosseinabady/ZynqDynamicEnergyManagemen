				 ...
				 )
{
	...
	rd_command->register_physical_offset_address = XVECTOR_ADD_CONTROL_BUS_ADDR_M_DATA;
	rd_command->value = (u32)DATA_LENGTH/n_;

	ioctl ( file_desc, FPGACL_DEVICE_IOWRITE, rd_command);
  	//---------------------------------------

	rd_command->device_kernel_base_address     = (void *)device_kernel_address_0;
	rd_command->register_physical_offset_address = XVECTOR_ADD_CONTROL_BUS_ADDR_A_DATA;
	rd_command->value = (u32)a/sizeof(DATA_TYPE);

	ioctl ( file_desc, FPGACL_DEVICE_IOWRITE, rd_command);
  	//---------------------------------------
	rd_command->device_kernel_base_address = (void *)device_kernel_address_0;
	rd_command->register_physical_offset_address = XVECTOR_ADD_CONTROL_BUS_ADDR_B_DATA;
	rd_command->value = (u32)b/sizeof(DATA_TYPE);

	ioctl ( file_desc, FPGACL_DEVICE_IOWRITE, rd_command);
  	//---------------------------------------
	rd_command->device_kernel_base_address = (void *)device_kernel_address_0;
	rd_command->register_physical_offset_address = XVECTOR_ADD_CONTROL_BUS_ADDR_C_DATA;
	rd_command->value = (u32)c/sizeof(DATA_TYPE);
...
//	printf("accel_write: ceck point 2\n");
	...
	rd_command->register_physical_offset_address = XVECTOR_ADD_CONTROL_BUS_ADDR_GIE;
	rd_command->value = 0;
...
void  accel_start( ) {
	...
	rd_command->device_physical_base_address = device_kernel_address_0;
	rd_command->register_physical_offset_address = XVECTOR_ADD_CONTROL_BUS_ADDR_AP_CTRL;
	rd_command->value = 0;
